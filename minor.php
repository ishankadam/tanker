...
<form action="minorc.php" onsubmit="return validate(this)" method="post">
  <div class="container">
    <h1>Enter Minor maintenance Details</h1>
    <hr>
    <label for="idma"><b>1.ID (AUTO) WITH START MI</b></label>
    <input type="text" placeholder="Enter ID (AUTO) WITH START MI" name="idmi" required>
    <label for="tt"><b>TT no</b></label>
    <input type="number" placeholder="Enter TT number" name="tt" required >
    
    <label for="load"><b>Load/Unload</b></label>
    <input type="text" placeholder="Load/Unload" name="load" required>
    ...
    <label for="billno"><b>Quantity</b></label>
